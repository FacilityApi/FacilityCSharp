...
namespace Facility.Core.Http
{
	...
	public static partial class HttpServiceErrors
	{
		...
		public static string? TryGetErrorCode(HttpStatusCode statusCode)
		{
			...
			{
			case 304:
				return ServiceErrors.NotModified;
			case 400:
				return ServiceErrors.InvalidRequest;
			case 401:
				return ServiceErrors.NotAuthenticated;
			case 403:
				return ServiceErrors.NotAuthorized;
			case 404:
				return ServiceErrors.NotFound;
			case 409:
				return ServiceErrors.Conflict;
			case 413:
				return ServiceErrors.RequestTooLarge;
			case 429:
				return ServiceErrors.TooManyRequests;
			case 500:
				return ServiceErrors.InternalError;
			case 503:
				return ServiceErrors.ServiceUnavailable;
			default:
				return null;
			}
		}

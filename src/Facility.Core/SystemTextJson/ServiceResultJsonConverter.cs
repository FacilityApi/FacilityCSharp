...
{
	public sealed class ServiceResultJsonConverter : JsonConverterFactory
	{
		public override bool CanConvert(Type typeToConvert) => typeToConvert.IsAssignableTo(typeof(ServiceResult));

		public override JsonConverter? CreateConverter(Type typeToConvert, JsonSerializerOptions options)
		{
			var valueType = typeToConvert.GetGenericArguments()[0];
			return (JsonConverter) Activator.CreateInstance(typeof(ServiceResultJsonConverter<>).MakeGenericType(valueType))!;
		}
	}

#pragma warning disable SA1402
	public sealed class ServiceResultJsonConverter<T> : JsonConverter<ServiceResult<T>>
	{
		/// <summary>
